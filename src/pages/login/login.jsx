    ...
    return (
        <div className="Login">
            <div className="loginHeader">
                ...
                <p>Join millions of other in sharing successful moves on HelpMeOut</p>
            </div>
            <button>
            ...
            <div><svg xmlns="http://www.w3.org/2000/svg" width="201" height="1" viewBox="0 0 201 1" fill="none">
                <path d="M0.5 0.5L200.5 0.500017" stroke="#B9C2C8" strokeLinecap="round" />
            </svg> or <svg xmlns="http://www.w3.org/2000/svg" width="201" height="1" viewBox="0 0 201 1" fill="none">
                    <path d="M0.5 0.5L200.5 0.500017" stroke="#B9C2C8" strokeLinecap="round" />
                </svg></div>
            <form action="">
