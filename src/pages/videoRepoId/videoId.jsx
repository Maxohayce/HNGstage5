...
const VideoId = () => {
    return (
        <div className="savedId">
            <MiniNav />
            <div className="savedIdTop">
                <div className="savedIdLink">
                    <p>Home</p>/
                    <p> Recent Videos</p>/
                    <p> How To Create A Facebook Ad Listing </p>
                </div>
                <div className="savedIdTitle">
                    <h3>How To Create A Facebook Ad Listing</h3>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22H15C20 22 22 20 22 15V13" stroke="#120B48" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M16.0399 3.02001L8.15988 10.9C7.85988 11.2 7.55988 11.79 7.49988 12.22L7.06988 15.23C6.90988 16.32 7.67988 17.08 8.76988 16.93L11.7799 16.5C12.1999 16.44 12.7899 16.14 13.0999 15.84L20.9799 7.96001C22.3399 6.60001 22.9799 5.02001 20.9799 3.02001C18.9799 1.02001 17.3999 1.66001 16.0399 3.02001Z" stroke="#120B48" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M14.9102 4.1499C15.5802 6.5399 17.4502 8.4099 19.8502 9.0899" stroke="#120B48" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                </div>
                <video src=""></video>
            </div>
            <div className="savedIdMid">
                <div className="sendVid">
                    <div className="sendVidDetails">
                        <input type="search" name="" id="" placeholder="enter email of receiver" />
                        <button className="sendEmail" type="submit">send</button>
                    </div>
                    <div className="sendVidUrl">
                        <input type="search" name="" id="" placeholder="enter email of receiver" />
                        <button className="copyUrl" type="submit"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <g clipPath="url(#clip0_611_1568)">
                                <path d="M4.16797 12.4998H3.33464C2.89261 12.4998 2.46868 12.3242 2.15612 12.0117C1.84356 11.6991 1.66797 11.2752 1.66797 10.8332V3.33317C1.66797 2.89114 1.84356 2.46722 2.15612 2.15466C2.46868 1.8421 2.89261 1.6665 3.33464 1.6665H10.8346C11.2767 1.6665 11.7006 1.8421 12.0131 2.15466C12.3257 2.46722 12.5013 2.89114 12.5013 3.33317V4.1665M9.16797 7.49984H16.668C17.5884 7.49984 18.3346 8.24603 18.3346 9.1665V16.6665C18.3346 17.587 17.5884 18.3332 16.668 18.3332H9.16797C8.24749 18.3332 7.5013 17.587 7.5013 16.6665V9.1665C7.5013 8.24603 8.24749 7.49984 9.16797 7.49984Z" stroke="#120B48" strokeWidth="1.67" strokeLinecap="round" strokeLinejoin="round" />
                            </g>
                            <defs>
            ...
            <div className="transcriptSection">
                <div className="transcriptTop">
                    <h6>Transcript</h6>
                    <input type="select" name="" id="" placeholder="English" />
                </div>
